			...
			<div class="frame frame-max">
				...
				<div class="bit-5">
					<div class="footer-column footer-column-social">
						<h3>Social</h3>
						<ul>
							<li><a href="#"><img src="http://cas.threecordsstudio.com/wp-content/themes/cas/images/igicon.2.png"></a></li>
							<li><a href="#"><img src="http://cas.threecordsstudio.com/wp-content/themes/cas/images/fbicon.2.png"></a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="frame frame-max">
			<div class="bit-2">
				<div class="footer-black-left">
					<img src="http://cas.threecordsstudio.com/wp-content/themes/cas/images/CAS-grey.3.png">
...
<!--<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/lib/venobox/venobox.min.js"></script>-->
	...
	<script src="http://cas.threecordsstudio.com/wp-content/themes/cas/js/cas.js"></script>
</body>
