...
<!--End Custom Overlay Frame-->
	...
	<div class="black-header">
		...
		<div class="black-header-item">
			<a href="#">
			<img src="https://communityallstars.com/wp-content/themes/cas-wp-theme/images/mail.png" alt="Email" class="l">
			EMAIL US</a>
		</div>
		<div class="black-header-item">
			<a href="#">PRESS</a>
		...
		<div class="black-header-item">
			<a href="#">TEAMBANK
			<img src="https://communityallstars.com/wp-content/themes/cas-wp-theme/images/teambank.png" alt="Team Bank" class="r"></a>
		</div>
	</div>
</div>
<div class="feature feature-page">
	...
	<div class="frame">
		<div class="bit-logo">
			<a href="<?php echo get_site_url(); ?>/"><img src="https://communityallstars.com/wp-content/themes/cas-wp-theme/images/CASLogoBIG.png" alt="CAS Logo"></a>
		</div>
		<div class="bit-nav">
			<?php wp_nav_menu( array( 'theme_location' => 'header-menu' ) ); ?>
		</div>
		...
		<div class="bit-search-icon">
			<div class="frame">
				<div class="bit-1"><a href="#"><img src="https://communityallstars.com/wp-content/themes/cas-wp-theme/images/searchglass.png" alt="Search" class="f-r"></a></div>
			</div>
		</div>
		<div class="bit-cart">
			<div class="frame">
				<div class="bit-1">
				<a href="https://communityallstars.com/checkout/">
					<img src="https://communityallstars.com/wp-content/themes/cas-wp-theme/images/shoppingcartbig.png" alt="Cart"></a>
				</div>
			</div>
		</div>
	</div>
