...
//      echo "Charge Credit Card TRANS ID  : " . $tresponse->getTransId() . "\n";
			...
			$message_string = "Charge Credit Card TRANS ID  : " . $tresponse->getTransId() . "<BR>" .
												...
												'Invoice Number: ' .  $_POST['invoice'] . '<br>' . 
			...
			$title_string =  "Invoice Paid: " . $_POST['invoice'];
									...
									<div class="bit-1">
										...
										<div class="form-panel">
											...
											<div class="form-item">
												...
												<p class="center">Your Invoice Number '  . $_POST['invoice'] . ' has been successfully processed.</p>
